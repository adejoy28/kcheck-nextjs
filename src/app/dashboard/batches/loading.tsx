export default function BatchesLoading() {
  return (
    <div>
      ...
      {/* DataTable skeleton - matching your DataTable component structure */}
      <div className="bg-white rounded-lg shadow">
        ...
        {/* Table skeleton matching your column structure */}
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3"><div className="h-4 bg-gray-200 rounded w-20 animate-pulse"></div></th>
                <th className="px-6 py-3"><div className="h-4 bg-gray-200 rounded w-16 animate-pulse"></div></th>
                <th className="px-6 py-3"><div className="h-4 bg-gray-200 rounded w-12 animate-pulse"></div></th>
